 ...
 *	æ¬¢è¿Žäº¤æµè½¬è½½ï¼Œä½†è¯·å°Šé‡ä½œè€…åŠ³åŠ¨æˆæžœï¼Œæ ‡æ˜Žæ’ä»¶æ¥æºåŠä½œè€…
 */
...
function fadeAB () {
	if (nowIndex != index) {
		...
		$(set.titleObj).eq(nowIndex).hide();//æ–°å¢žåŠ title
		$(set.titleObj).eq(index).show();//æ–°å¢žåŠ title
		nowIndex = index;
